...
def get_numeric(
    ...
    *,
    ...
    """
    columns = sheet.get_values(
        spreadsheet_id, range_="A1:1", sheets_service=sheets_service
    )
...
def get_letter(
    ...
    *,
    ...
    """
    numeric_index = get_numeric(
        spreadsheet_id, column_name=column_name, sheets_service=sheets_service
    )
    if numeric_index is None:
        return None
    number_to_upper = {
        num: upper for num, upper in enumerate(string.ascii_uppercase, 0)
    }
