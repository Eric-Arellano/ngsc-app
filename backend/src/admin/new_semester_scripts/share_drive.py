...
def check_new_leadership_different() -> None:
    ...
    """
    leadership_different = (
        (leadership.chief_of_staff != new_leadership.chief_of_staff)
...
def confirm_email_message_good() -> None:
    ...
    answer = command_line.ask_yes_no(question="Is this good to go?", default="yes")
    if answer is False:
        raise SystemExit(
            textwrap.dedent(
                """\
...
@command_line.log(
    start_message="Adding permissions & sharing Drive folders with new leadership.",
