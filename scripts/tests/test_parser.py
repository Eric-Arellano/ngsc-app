...
def assert_raises_parser_error(
        command_options: CommandOptionList,
        args: List[str]):
...
def assert_backend_and_frontend_raise_error(args: List[str]):
    assert_raises_parser_error(command_options=backend.command_options,
                               args=args)
    assert_raises_parser_error(command_options=frontend.command_options,
                               args=args)
