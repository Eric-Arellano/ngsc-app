    ...
    <div>
        ...
        <BioGroup header={"Committee Chairs"}>
            <Bio name={"Diana Chen"} position={"Admin"} email={"dkchen1@asu.edu"}
                 pictureURL={"https://media.licdn.com/media/AAEAAQAAAAAAAAPmAAAAJDE2YWU4NThmLTkyNGYtNDg4NC04MzQyLWFlZTljMDk4ZGQ4Nw.jpg"}/>
            ...
            <Bio name={"Matthew Moy"} position={"Civil-Mil"} email={"matthew.moy@asu.edu"}
                 pictureURL={"https://media.licdn.com/media/AAMABADGAAwAAQAAAAAAABHxAAAAJDcwNGRmNjMyLTEwNjctNDYxYy04MDYzLTQ5ZGJmMGRlMWI3Mg.jpg"}/>
        ...
        <BioGroup header={"Mission Team Leaders 1-15"}>
            ...
            <Bio name={"McKenna Byrne"} position={"MT4: Racial & LGBTQ Equality"} email={"mckenna.byrne@asu.edu"}
                 pictureURL={"https://media.licdn.com/media/AAEAAQAAAAAAAAhuAAAAJGU2MjIyYmEwLTgzNDktNDA0Zi04MDE4LTRiMDc1ZmJhOTI5OQ.jpg"}/>
            ...
            <Bio name={"Abigail Walker"} position={"MT6: Cultural & Global Equality"} email={"abigail.m.walker@asu.edu"}
        ...
        <BioGroup header={"Mission Team Leaders 16-30"}>
            <Bio name={"Brandon Lew"} position={"MT16: Veterans Healthcare & Services"} email={"brandon.lew@asu.edu"}
